...
class FinetunerTrainer:
    def __init__(self,
                 ...
                 num_classes=60,
                 log_freq=100,
                 model_path="/Users/zhemingan/anaconda3/lib/python3.11/site-packages/signaturesnet/trained_models/Zheming/finetuner_large/",  # File where to save model learned weights None to not save
