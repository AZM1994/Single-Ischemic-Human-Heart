...
class ClassifiedFinetunerErrorfinder:
    ...
    def __call__(self,
        ...
        print("finetuner_guess_realistic, baseline_guess_random", finetuner_guess_realistic.size(), baseline_guess_random.size())
        ...
        print("finetuner_guess", finetuner_guess, finetuner_guess.size())
