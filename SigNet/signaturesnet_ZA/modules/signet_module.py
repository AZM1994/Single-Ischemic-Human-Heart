        ...
        with torch.no_grad():
            ...
            if only_NNLS:
                result = SigNetResult(mutation_dataset,
                                  ...
                                  lower=torch.full((mutation_dataset.shape[0],60), float('nan')),
                                  upper=torch.full((mutation_dataset.shape[0],60), float('nan')),
    ...
    def plot_results(self, 
        ...
        if compute == 'True':
            ...
            for i in range(self.weights.shape[0]):
                plot_weights(guessed_labels=self.weights[i,:60], 
