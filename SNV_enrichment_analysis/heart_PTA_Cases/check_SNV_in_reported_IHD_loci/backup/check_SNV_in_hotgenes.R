...
Control.SNV_gene_list <- read.csv("./normal_results/gene_list/heart_PTA_Cases_Normal.SNV_gene_list.csv", header = TRUE)
heart_PTA_Cases_Control_vcf <- read.table("heart_PTA_Cases.all_normal_ssnv.vcf", sep = "\t")
...
IHD.SNV_gene_list <- read.csv("./disease_results/gene_list/heart_PTA_Cases_Disease.SNV_gene_list.csv", header = TRUE)
heart_PTA_Cases_IHD_vcf <- read.table("heart_PTA_Cases.all_disease_ssnv.vcf", sep = "\t")
...
reported_IHD_loci <- read.csv("./check_SNV_in_hotgenes/hot_gene_list_heart_pta_02.csv", header = FALSE)
...
pdf("./check_SNV_in_hotgenes/cell_specific_SNV_count_in_hotgene_list.pdf", width = 12, height = 12)
...
melt_combined.count_summary <- melt_combined.count_summary %>% filter(SNV_count > 0)
