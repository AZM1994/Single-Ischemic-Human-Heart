...
all_gene_normal_GO_filtered <- all_gene_normal_GO %>% 
  ...
  mutate(over_represented_pvalue_corrected = over_represented_pvalue)
...
# pdf("GO_results/all_gene_normal_GO.pdf", width = 10, height = 15)
...
pdf("GO_results/all_gene_GO_barplot.pdf", width = 20, height = 25)
