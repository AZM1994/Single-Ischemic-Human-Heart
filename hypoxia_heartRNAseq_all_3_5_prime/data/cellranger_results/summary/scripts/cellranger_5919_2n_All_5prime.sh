...
#SBATCH -t 3-00:00
#SBATCH -p medium
#SBATCH -o 5919_2n_All_5prime_%j.out
#SBATCH -e 5919_2n_All_5prime_%j.err
...
cellranger count \
--id=5919_2n_All_5prime \
--transcriptome=/n/shared_db/GRCh38/uk/cellranger/7.0.0/7.0.0/refdata-gex-GRCh38-2020-A \
--fastqs=/n/no_backup2/bch/lee/zheming/single_cell_RNAseq/heart_RNAseq/fastq/5919_2n_All_5prime