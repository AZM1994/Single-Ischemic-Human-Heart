...
ggsave(paste0(other_figure_dir, "/5-sSNV_strand_counts_AMG.pdf"), plot = barplot_sc_AMG, width = 15, height = 10, dpi = 600)
...
ggsave(paste0(other_figure_dir, "/5-sSNV_strand_ratio_AMG.pdf"), plot = barplot_sr_AMG, width = 10, height = 6, dpi = 600)
