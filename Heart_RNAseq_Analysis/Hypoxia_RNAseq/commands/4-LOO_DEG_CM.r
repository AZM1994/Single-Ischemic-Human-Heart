...
saveRDS(LOO_DEG_list, file = paste0(LOO_DEG_CM_dir, "/LOO_DEG_CM_only_no_filter.RDS"))
...
ggsave(paste0(LOO_DEG_CM_dir, "/LOO_DEG_pheatmap.pdf"), plot = p, width = 15, height = 6, dpi = 300)
...
write.csv(LOO_DEG_up_down_df_ext, paste0(LOO_DEG_CM_dir, "/LOO_DEG_filtered.csv"))
