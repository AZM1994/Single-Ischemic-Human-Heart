...
# atac_5919_all <- read.table("./data/ATAC_cov_average_hg19_1kb_bin.5919_all.bed") %>% setNames(c("chr", "start", "end", "id", "score_5919_all"))
atac_5828_2n <- read.table("./data/ATAC_cov_average_hg19_1kb_bin.5828_2n.bed") %>% setNames(c("chr", "start", "end", "id", "score_5828_2n"))
